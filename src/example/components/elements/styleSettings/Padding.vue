    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-form-item label="Top" v-if="styleExist('padding-top')">
          <el-slider
            :model-value="getStyle('padding-top')"
            @input="setStyle('padding-top', $event)"
          />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="Right" v-if="styleExist('padding-right')">
          <el-slider
            :model-value="getStyle('padding-right')"
      ...
      <el-col :span="12">
        <el-form-item label="Bottom" v-if="styleExist('padding-bottom')">
          <el-slider
            :model-value="getStyle('padding-bottom')"
      ...
      <el-col :span="12">
        <el-form-item label="Left" v-if="styleExist('padding-left')">
          <el-slider
            :model-value="getStyle('padding-left')"
            @input="setStyle('padding-left', $event)"
          />
        </el-form-item>
      </el-col>
    </el-row>
